...
This document describes version 0.26 of YAML::Syck, released
January 16, 2005.
...
C<!hs/Foo> tag is blessed into C<hs::Foo>.  There is currently no way to
customize this behaviour; consider using L<Class::Rebless> for the time being.
